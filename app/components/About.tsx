...
function About() {
  return (
    <FadeOut scroll={800}>
      <div className="h-screen flex flex-col gap-4 lg:flex-row justify-center items-center">
        <motion.div
        ...
        >
          <Image
            src={Devices}
            alt="Phone"
            className="dark:border dark:border-black dark:rounded-xl"
          />
        </motion.div>
        <div className="flex flex-col justify-center items-center w-1/2">
          ...
          <div className="font-bold text-5xl mb-4">The Qalite App</div>
